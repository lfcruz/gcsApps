...
function populateQueue(){
    ...
    if (!empty($queues)){
        foreach ($queues as $queue){
            ...
            pgQResult("update t_queue set campaing_id = $1, targets_id = $2, campaing_type_id = $3 where queue_id = $4", array($activeCampaings[0]['campaingid'], $activeCampaings[0]['targetsid'], $activeCampaings[0]['campaing_type'], $queue['queue_id']));
        }
    }    
}
