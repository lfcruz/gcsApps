...
pgQResult("update t_campaings set status = 'A' where campaing_id = $1", array($_GET['campaingid']));
...
email("<Broadcast Manager>bmanager@gcs-systems.com","broadcastapproved@gcs-systems.com", "Broadcast Approval.", "Hello,\r\nScheduled campaign ".$_GET['campaingname']." has been approved.\r\nRegards,");
