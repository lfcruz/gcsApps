...
<html>
    <head>
        ...
        <title> GCS Brocast Campaing Manager - Deleting targets.....</title>
...
pgQResult("delete from t_targets_details where targets_id = $1", array($_GET['record']));
pgQResult("delete from t_targets where targets_id = $1", array($_GET['record']));
