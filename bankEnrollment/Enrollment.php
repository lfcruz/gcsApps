    ...
    if($bank == null && $status == null){
        echo '<form name="form1" method="post" action="">';
            ...
            echo '<select name="telco">';
                ...
                echo '<option value="50">Digicel</option>';
                echo '</select></br>';
            ...
            echo '<select name="tipodoc">';
                ...
                echo '</select></br>';
            echo 'Numero de Documento  <input type="text" name="documento" value="0987654321"><br/>';
            echo 'Telefono  <input type="text" name="MSISDN" value="8097770001"><br/>';
            echo 'Sexo  ';
            echo '<select name="gender">';
                echo '<option value="M">Masculino</option>';
                echo '<option value="F">Femenino</option>';
                echo '</select><br/>';
            echo 'Nombre  <input type="text" name="fname" value="L"><br/>';
            echo 'Segundo Nombre <input type="text" name="mname" value="F"><br/>';
            echo 'Apellido  <input type="text" name="lname" value="C"><br/>';
            echo 'Segundo Apellido <input type="text" name="sname" value="D"><br/>';
